...
'''
num_test = -ow
train_set = feature[:num_test]
test_set = feature[num_test:]
scaler = MinMaxScaler()
train_scaled = scaler.fit_transform(train_set)
x_train = train_scaled
x_train.shape #(4201, 21)
...
for b in train_loader:
     inputs, outputs = b
     break
inputs.size() #torch.Size([64, 365, 21])
outputs.size() #torch.Size([64, 120, 1])
print(outputs[:,:,0])
'''
#%%
epoch = 100
