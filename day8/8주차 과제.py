...
Original file is located at
    https://colab.research.google.com/drive/1DbhE89SBRqsTZv9irverO2oZQUTSJHah
"""
...
# 7주차에서 rnn 셀을 직접 구현하는 대신, 파이토치의 nn.RNN()을 이용하여 모델 구현 및 학습하기
...
model = nn.RNN(n_input, n_hidden, batch_first=True)
